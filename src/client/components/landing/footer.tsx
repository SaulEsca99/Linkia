    ...
    <footer className="py-16 px-6 border-t border-border">
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-5 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Tu copiloto de empleo impulsado por IA. Encuentra el trabajo ideal en México y LATAM.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-foreground transition-colors">Guías de CV</Link></li>
              <li><Link href="/dashboard/ayuda" className="hover:text-foreground transition-colors">Ayuda</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">© 2026 Linkia. Todos los derechos reservados.</p>
