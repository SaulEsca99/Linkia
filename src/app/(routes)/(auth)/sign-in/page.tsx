        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-white leading-tight">
                Tu carrera profesional merece un copiloto inteligente
              </h1>
              <p className="text-xl text-white/70 leading-relaxed">
                Deja que la IA analice tu perfil y encuentre las oportunidades perfectas para ti.
              </p>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
            <p className="text-white/90 italic mb-4">
              &ldquo;Conseguí trabajo en 2 semanas. Linkia adaptó mi CV perfectamente para cada aplicación.&rdquo;
            </p>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <Button type="submit" className="w-full h-12 text-base font-medium gap-2" disabled={isLoading}>
                {isLoading ? (
                  <><div className="h-4 w-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> Iniciando...</>
                ) : (
